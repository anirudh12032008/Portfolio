            ...
            <div className="pt-8 sm:pt-10 lg:pl-8 lg:pt-0">
              ...
              <div className="flex flex-col justify-center pt-3 sm:flex-row sm:pt-5 lg:justify-start">
                ...
                <div className="flex items-center justify-center pt-5 pl-2 sm:justify-start sm:pt-0">
                  ...
                  <Link href={profile.youtube} className="pl-4">
                    <i className="bx bxl-dribbble text-2xl text-white hover:text-yellow"></i>
                  </Link>
                  <Link href={profile.discord} className="pl-4">
                    <i className="bx bxl-linkedin text-2xl text-white hover:text-yellow"></i>
                  </Link>
                  <Link href={profile.instagram} className="pl-4">
          ...
          <div className="w-full pl-0 pt-10 sm:w-3/4 lg:w-2/5 lg:pl-12 lg:pt-0">
            <div>
              <div className="flex items-end justify-between">
                ...
                <h3 className="font-body text-3xl font-bold text-primary">{profile.field1percent}</h3>
              </div>
              <div className="mt-2 h-3 w-full rounded-full bg-lila">
                <div className="h-3 rounded-full bg-primary" style={{ "width": profile.field1percent }}></div>
              </div>
            </div>
            <div className="pt-6">
              <div className="flex items-end justify-between">
                <h4 className="font-body font-semibold uppercase text-black">{profile.field2}</h4>
                <h3 className="font-body text-3xl font-bold text-primary">{profile.field2percent}</h3>
              </div>
              <div className="mt-2 h-3 w-full rounded-full bg-lila">
                <div className="h-3 rounded-full bg-primary" style={{ "width": profile.field2percent }}></div>
              </div>
            </div>
            <div className="pt-6">
              <div className="flex items-end justify-between">
                ...
                <h3 className="font-body text-3xl font-bold text-primary">{profile.field3percent}</h3>
              </div>
              <div className="mt-2 h-3 w-full rounded-full bg-lila">
                <div className="h-3 rounded-full bg-primary" style={{ "width": profile.field3percent }}></div>
              </div>
            </div>
            <div className="pt-6">
              <div className="flex items-end justify-between">
                <h4 className="font-body font-semibold uppercase text-black">{profile.field4}</h4>
                <h3 className="font-body text-3xl font-bold text-primary">{profile.field4percent}</h3>
              </div>
              <div className="mt-2 h-3 w-full rounded-full bg-lila">
                <div className="h-3 rounded-full bg-primary" style={{ "width": profile.field4percent }}></div>
              </div>
            </div>
          </div>
        </div>
                ...
                <div className="mt-1 flex">
                  ...
                  <div className="md:-mt-1 md:pl-8">
                    ...
                    <span className="block pt-2 font-header text-xl font-bold uppercase text-primary">Frontend
                      Developer</span>
                    <div className="pt-2">
                      <span className="block font-body text-black"></span>
                    </div>
                  </div>
                </div>
              </div>
