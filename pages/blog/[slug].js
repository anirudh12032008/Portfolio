          ...
          <div className="mx-auto max-w-4xl">
            <div className="">
              ...
              <div className="flex items-center pt-5 md:pt-10">
                <div>
                  <img
                    src={`${builder.image(author.image).url() || '/assets/img/blog-author.jpg'}`}
                ...
                <div className="pl-5">
                  <span className="block font-body text-xl font-bold text-grey-10">{author.title}</span>
            ...
            <div
              ...
              <div className="w-3/4 sm:w-2/5 lg:w-1/4 xl:w-1/5">
                <img src={`${builder.image(author.image).url() || '/assets/img/blog-author.jpg'}`} className="rounded-full shadow" alt="author image" />
              </div>
      ...
      <div className="bg-primary">
        <div className="container flex flex-col justify-between py-6 sm:flex-row">
          <p className="text-center font-body text-white md:text-left">
            © Copyright 2022. All right reserved, Made with <i className="bx bx-heart text-white text-lg"></i> by Anirudh
          </p>
